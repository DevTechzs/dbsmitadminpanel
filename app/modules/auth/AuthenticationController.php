    ...
    function Route($data)
    {
        ...
        switch ($data["Page_key"]) {
            ...
            case "UpdatePendingStaffAttendance":
                $result =  (new CronJob())->UpdatePendingStaffAttendance($jsondata);
                break;
            case "UpdatePendingInternAttendance":
                $result =  (new CronJob())->UpdatePendingInternAttendance($jsondata);
                break;

            case "getAllActiveWhatsappCampaign":
                $result =  (new Marketing())->getAllActiveWhatsappCampaign(); //API call 
                break;
