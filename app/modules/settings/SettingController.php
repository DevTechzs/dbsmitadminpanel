    ...
    function Route($data)
    {
        ...
        switch ($data["Page_key"]) {
            ...
            case "addTrainingTypes":
                return (new Training())->addTrainingTypes($jsondata); // added by Dev on 06/05/24


            case "addTraining":
                return (new Training())->addTraining($jsondata); // added by Dev on 06/05/24

            case "getAllTraining":
                return (new Training())->getAllTraining(); // added by Dev on 06/05/24

            case "getStaffUnderSupervisor":
                return (new Warning())->getStaffUnderSupervisor(); //added by Devkanta on 14/06/2024
