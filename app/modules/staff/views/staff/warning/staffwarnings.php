...
<script>
    $(function() {
        getAllWarningTypes();
        getStaffUnderSupervisor();
        getStaffWarningsUnderSupervisor();
        getStaffWarnings();
    });
var flag=1;
    ...
    function getStaffUnderSupervisor() {
        var obj = new Object();
        obj.Module = "Settings";
        obj.Page_key = "getStaffUnderSupervisor";
        var json = new Object();
        obj.JSON = json;
        SilentTransportCall(obj);
    }
    ...
    function getStaffWarningsUnderSupervisor() {
        var obj = new Object();
        obj.Module = "Staff";
        obj.Page_key = "getStaffWarningsUnderSupervisor";
        var json = new Object();
        obj.JSON = json;
        SilentTransportCall(obj);
    }
    ...
    function loaddata(data) {
        ...
        if (data.length == 0) {
            ...
            for (let i = 0; i < data.length; i++) {
                text += '<tr> ';
                text += '<th> ' + (i + 1) + '</th>';
                // text += '<td> ' + data[i].WarnedByName + '</td>';
                text += '<td> ' + data[i].WarningStaffName + '</td>';
